...
<form id="contact_form" method="post">
    ...
    <div class="row">
        ...
        <input id="birth_date" required class="input datepicker" name="birth_date" type="text" value="mm/dd/yyyy" size="30" /><br />
    </div>
    <div class="row">
        <br />
    ...
    <div class="row">
        ...
        <input id="membership_date" required class="input datepicker" name="membership_date" type="text" value="mm/dd/yyyy" size="30" /><br />
    </div>
    <div class="row">
        <br />
